...
**Vault-grade secret management for OpenEnvX.**

Local-first, zero-config, agent-ready by design.
...
Values in your `.env` are expanded when you run commands or use `openenvx get`.
...
MIT License · [GitHub](https://github.com/openenvx/cli)
